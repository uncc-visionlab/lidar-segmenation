...
def UNet(input_shape, NUM_CLASSES=1, dropout_rate=0.0, batch_norm=True):
    ...
    conv_final = layers.Activation('softmax')(conv_final)  #Change to softmax for multichannel/'sigmoid'
...
UNet(input_shape, NUM_CLASSES=2, dropout_rate=0.0, batch_norm=True)